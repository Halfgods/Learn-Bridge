  ...
  return (
    <div className="p-6 lg:p-10 max-w-3xl mx-auto space-y-6 pb-24">
      ...
      <div className="clay-lg bg-card p-6 space-y-4">
        ...
        <div>
          <label htmlFor="deadline-new-quiz" className="text-sm font-bold text-foreground/80 ml-2">Deadline</label>
          <div className="mt-2 clay-pressed bg-card rounded-2xl px-4 h-12 flex items-center gap-2">
            <label htmlFor="dealine-new-quiz"><CalendarDays className="w-4 h-4 text-muted-foreground shrink-0" /></label>
            <input
              id="deadline-new-quiz"
              type="datetime-local"
